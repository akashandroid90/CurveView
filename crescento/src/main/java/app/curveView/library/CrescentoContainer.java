...
public class CrescentoContainer extends RelativeLayout {
    ...
    int width = 0;
    int height = 0;
    int gravity = CrescentoImageView.Gravity.TOP;
    /**
     * @param curvatureHeight changes the amount of curve. Default is 50.
     */
    int curvatureHeight = 50;
    int curvatureDirection = CrescentoImageView.CurvatureDirection.OUTWARD;
    Paint mPaint;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (styledAttributes.hasValue(R.styleable.CrescentoImageView_gravity)) {
            if (styledAttributes.getInt(R.styleable.CrescentoImageView_gravity, 0) == CrescentoImageView.Gravity.BOTTOM) {
                gravity = CrescentoImageView.Gravity.BOTTOM;
            } else {
                gravity = CrescentoImageView.Gravity.TOP;
            }
        }
